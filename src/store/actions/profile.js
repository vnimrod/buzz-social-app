...
export const getProfile = () => {
  return async (dispatch) => {
    try {
      const res = await axios.get(process.env.REACT_APP_BACKEND_URL + '/profile/me');
...
export const getProfileByUid = (uid) => {
  return async (dispatch) => {
    try {
      const res = await axios.get(process.env.REACT_APP_BACKEND_URL +`/profile/user/${uid}`);
...
export const createProfile = (formData, history, success = false) => {
  return async (dispatch) => {
    ...
    try {
      const res = await axios.post(process.env.REACT_APP_BACKEND_URL + '/profile', formData, config);
...
export const updateProfile = (formData, history, success = false) => {
  return async (dispatch) => {
    ...
    try {
      const res = await axios.patch(process.env.REACT_APP_BACKEND_URL + '/profile/me', formData, config);
...
export const uploadAvatar = (image) => {
  return async (dispatch) => {
    ...
    const res = await axios.post(process.env.REACT_APP_BACKEND_URL + '/profile/me/avatar', image, config);
    try {
      dispatch({
...
export const getAvatar = (uid) => {
  return async (dispatch) => {
    try {
      const avatar = await axios.get(process.env.REACT_APP_BACKEND_URL + `/profile/${uid}/avatar`);
...
export const addEducation = (formData, history, success = false) => {
  return async (dispatch) => {
    ...
    try {
      const res = await axios.put(process.env.REACT_APP_BACKEND_URL + '/profile/education', formData, config);
      dispatch({
        type: actionTypes.GET_PROFILE,
        payload: res.data,
      });
...
export const deleteEducation = (eid) => {
  return async (dispatch) => {
    try {
      const res = await axios.delete(process.env.REACT_APP_BACKEND_URL + `/profile/education/${eid}`);
...
export const deleteProfile = () => async (dispatch) => {
  if (
    ...
    try {
      await axios.delete(process.env.REACT_APP_BACKEND_URL + '/profile/me');
